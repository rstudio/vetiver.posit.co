...
If you plan to bring vetiver to a public or private cloud outside of [RStudio Connect](https://www.rstudio.com/products/connect/), [Docker](https://www.docker.com/) containers are a highly portable solution. Using vetiver makes Dockerfile creation easy by generating the files you need from your trained models.
...
- [Docker info from RStudio Solutions Engineering](https://solutions.rstudio.com/environments/docker/)
