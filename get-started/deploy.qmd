...
For [RStudio Connect](https://www.rstudio.com/products/connect/), you can deploy your versioned model with a single function, either `vetiver_deploy_rsconnect()` for R or `vetiver.deploy_rsconnect()` for Python. For more on these options, see the [Connect documentation for using vetiver](https://docs.rstudio.com/connect/user/vetiver/).
