...
```{=html}
<script src="https://fast.wistia.com/embed/medias/w7p0op712v.jsonp" async></script>
```
```{=html}
<script src="https://fast.wistia.com/assets/external/E-v1.js" async></script>
```
::: {.wistia_responsive_padding style="padding:107.92% 0 0 0;position:relative;"}
::: {.wistia_responsive_wrapper style="height:100%;left:0;position:absolute;top:0;width:100%;"}
::: {.wistia_embed .wistia_async_w7p0op712v .videoFoam=true style="height:100%;position:relative;width:100%"}
...
<img src="https://fast.wistia.com/embed/medias/w7p0op712v/swatch" style="filter:blur(5px);height:100%;object-fit:contain;width:100%;" aria-hidden="true" onload="this.parentNode.style.opacity=1;"/>
:::
:::
:::
:::
...
FastAPI and Plumber APIs such as these can be hosted in a variety of ways. You can create a ready-to-go file for deployment that is especially suited for [RStudio Connect](https://www.rstudio.com/products/connect/).
